...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    hi clear Error
    hi clear ErrorMsg
    call <SID>X("Error", "fa4042", "", "bold,underline")
    call <SID>X("ErrorMsg", "fa4042", "", "bold,underline")
    ...
    hi clear SpellRare
    hi clear SpellLocal
    call <SID>X("SpellBad", "fa4042", "", "underline")
    call <SID>X("SpellCap", "aa4042", "", "underline")
    call <SID>X("SpellRare", "aa4042", "", "underline")
    call <SID>X("SpellLocal", "aa4042", "", "underline")
    ...
    "Line numbers
    hi clear LineNr
    call <SID>X("LineNr", "c0c1c2", "303132", "bold")
    call <SID>X("CursorLineNr", "d0d142", "303132", "bold")

    call <SID>X("ModeMsg", "daa520", "", "")
    call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "addbe7", "none", "")
